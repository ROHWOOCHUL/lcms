          ...
          <aside className="w-64" aria-label="Sidebar">
            <div className="px-3 py-4 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800 h-screen">
              <ul className="space-y-2">
                <li>
                  <a
                    href="/agora?appId=f964fae738a94dda88c3c54438449f49&channelName=test72019490&userName=aa&isAdmin=true"
                  ...
                  >
                    ...
                    <span className="ml-3">선생님 입장</span>
                  </a>
                </li>
                <li>
                  <a
                    href="/agora?appId=f964fae738a94dda88c3c54438449f49&channelName=test72019490&userName=aabb&isAdmin=false"
                    className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                    <svg
                      aria-hidden="true"
